-- Migration 021: Insert PVs RJOMNB (260179-260184)
...
UPDATE pv SET ral = '14431506' WHERE numero_pv IN ('260179', '260180') AND (ral = '0' OR ral IS NULL OR ral = '');
...
FROM pv p
WHERE p.numero_pv IN ('260179', '260180')
...
FROM pv p
WHERE p.numero_pv IN ('260181', '260182', '260183', '260184')
  AND NOT EXISTS (SELECT 1 FROM pv_item pi WHERE pi.pv_id = p.id AND pi.numero_item = 66);
